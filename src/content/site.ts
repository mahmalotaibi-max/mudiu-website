...
export const siteMeta = {
  ...
  description:
    "مُضيّ علامة سعودية متخصصة في الاستشارات الاستراتيجية، تطوير القدرات المؤسسية، والتدريب المهني التطبيقي، تساعد الأفراد والمؤسسات على تحويل الفكرة إلى أثر قابل للقياس.",
  url: "https://mudiu.co",
};
