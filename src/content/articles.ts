...
export const articles: Article[] = [
  ...
  },
  {
    ...
    type: "مقال",
    icon: "growth",
    title: "ثلاث نقرات بدل نصف يوم: هكذا تُقاس المنفعة الحقيقية",
    summary:
      "أحمد لم يعد يأخذ إجازة من العمل ليحوّل مبلغًا بسيطًا لأخته. قصة قصيرة عن الفرق بين ميزة تُلغي مشكلة حقيقية، وميزة حادية عشرة لا يشعر بها أحد.",
    date: "2026-09-19",
    readMinutes: 4,
    blocks: [
      {
        type: "paragraph",
        text: "كان أحمد يأخذ نصف يوم إجازة، يقود إلى أقرب فرع بنك، ويقف في طابور - فقط ليحوّل مبلغًا بسيطًا لأخته. اليوم، يفتح تطبيق البنك، يضغط ثلاث نقرات، وينتهي الأمر قبل أن يرفع كوب قهوته.",
      },
      {
        type: "paragraph",
        text: "هذا الفرق - بين نصف يوم وثلاث نقرات - هو بالضبط ما نقصده بـ\"المنفعة\". ومعظم المؤسسات، للأسف، لا تزال تقيس نجاحها بعدد المستخدمين أو عدد الميزات، لا بحجم الفرق الذي أحدثته في حياة أحمد.",
      },
      {
        type: "heading",
        text: "ميزة واحدة، في تطبيق بنك",
      },
      {
        type: "list",
        items: [
          "المخرج: إطلاق ميزة \"التحويل الفوري\" داخل تطبيق الجوال.",
          "المنفعة: نصف يوم يعود لأحمد، كل مرة يحتاج فيها للتحويل.",
        ],
      },
      {
        type: "paragraph",
        text: "لكن لاحظ ماذا يحدث بعدها: الميزة الحادية عشرة التي يضيفها البنك - ربما لون جديد للواجهة، أو نقل زر من مكان لآخر - لن تُشعر أحمد بفرق يُذكر. لماذا؟ لأن أكبر \"ألم\" في حياته - نصف يوم ضائع - عولج بالفعل من الميزة الأولى.",
      },
      {
        type: "quote",
      ...
      {
        type: "paragraph",
        text: "وهذا هو الفخ الذي تقع فيه كثير من المؤسسات: تستمر في التحسين حول نفس النقطة، بينما توجد نقطة ألم أخرى، لعميل آخر، لم تُحل بعد - وهي تنتظر.",
      },
      {
        type: "heading",
        text: "قاعدة واحدة لكل قطاع",
      },
      {
        type: "paragraph",
        text: "الحكومة تتوسع بثقة حين تعرف أي خدمة توفر وقتًا حقيقيًا للمواطن. الشركة تتوسع حين تعرف أي ميزة يدفع العميل من أجلها فعلًا. والجمعية غير الربحية تتوسع حين تثبت للمانح أن كل ريال غيّر شيئًا حقيقيًا. الثلاثة يسألون، في جوهرهم، السؤال نفسه: أين تكمن أكبر منفعة لم تتحقق بعد؟",
      },
      {
        type: "quote",
      ...
      {
        type: "paragraph",
        text: "في مُضيّ، لا نسأل \"كم ميزة يمكن أن نضيف؟\"، بل \"أين ما زال أحمد ينتظر؟\". نساعد الجهات الحكومية والشركات والمؤسسات غير الربحية على تحديد نقطة الألم الحقيقية التالية، قبل أن تستثمر في ميزة حادية عشرة لا يشعر بها أحد.",
      },
      {
        type: "quote",
