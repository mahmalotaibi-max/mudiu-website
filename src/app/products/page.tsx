            ...
            {products.map((product, i) => (
              <RevealOnScroll key={product.slug} delay={i * 80}>
                <Link
                  ...
                  className="group flex h-full flex-col justify-between rounded-2xl border border-line p-8 transition-all duration-300 hover:-translate-y-1 hover:border-ink hover:shadow-[0_20px_40px_-24px_rgba(10,10,12,0.25)]"
                >
                  <div>
