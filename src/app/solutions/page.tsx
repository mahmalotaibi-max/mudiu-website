...
import { ServicesNetworkMark } from "@/components/sections/ServicesNetworkMark";
                ...
                {items.map((service, i) => (
                  <RevealOnScroll key={service.slug} delay={i * 80}>
                    <Link
                      ...
                      className="group flex h-full flex-col justify-between rounded-2xl border border-line bg-paper p-7 transition-all duration-300 hover:-translate-y-1.5 hover:scale-[1.01] hover:border-ink hover:shadow-[0_28px_56px_-28px_rgba(30,47,82,0.4)]"
                    >
                      <div>
