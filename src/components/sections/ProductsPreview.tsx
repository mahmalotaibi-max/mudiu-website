          ...
          {productsPreview.items.map((product, i) => (
            <RevealOnScroll key={product.slug} delay={i * 100}>
              <Link
                ...
                className="group flex h-full flex-col justify-between rounded-2xl border border-line bg-paper p-8 transition-all duration-300 hover:-translate-y-1.5 hover:scale-[1.01] hover:border-ink hover:shadow-[0_28px_56px_-28px_rgba(63,74,60,0.4)]"
              >
                <div>
