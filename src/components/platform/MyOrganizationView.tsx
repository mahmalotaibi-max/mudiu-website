...
const strings = {
  en: {
    ...
    findingsTitle: "Signals",
    findingsBody: "The signals from your last diagnostic, and where each one stands.",
    noFindings: "No signals are tracked yet - nothing surfaced, or the diagnostic hasn't been completed.",
  ...
  ar: {
    ...
    findingsTitle: "الإشارات",
    findingsBody: "الإشارات التي ظهرت في آخر تشخيص، وحالة كل واحدة منها.",
    noFindings: "لا توجد إشارات متتبَّعة بعد - إما لم تظهر أي إشارة، أو لم يُكمَل التشخيص بعد.",
